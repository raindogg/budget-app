class GoalsController < ApplicationController
  ...
  def create
    Goal.create(cat_id: 1, amount: params[:bills])
    Goal.create(cat_id: 2, amount: params[:income])
    Goal.create(cat_id: 3, amount: params[:groceries])
    Goal.create(cat_id: 4, amount: params[:intox])
    Goal.create(cat_id: 5, amount: params[:transportation])
    Goal.create(cat_id: 6, amount: params[:pets])
    Goal.create(cat_id: 7, amount: params[:restaurants])
    Goal.create(cat_id: 8, amount: params[:entertainment])
    Goal.create(cat_id: 9, amount: params[:misc])
    Goal.create(cat_id: 10, amount: params[:savings])
